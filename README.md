...
### Список тем
1. Создать навык Алисы [Python API](https://yandex.ru/dev/dialogs/alice/doc/quickstart-python.html) (Гусевская Арина, Фомин Валентин - R3180) [Проект](https://github.com/GusyLebedy/term-project)
