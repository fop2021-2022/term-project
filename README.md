...
5. Поиск контуров на картинке (с камеры) и сохранение контуров в вектороное изображение svg (Нестеренко, Панфилова, Резанцева, Прохорова, Филиппов R3181 [НАШ РЕПОЗИТОРИЙ](https://github.com/nem1sha/term-project.git)
...
15. Ваши темы... (Бот телеграмм, путеводитель по СПб; Коновалов Максим, Кербер Егор, Смирнова Анна, Важенин Владимир, Орёл Арсений; https://github.com/Zombie1995/AliceForSPB)
